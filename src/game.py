...
def main():
    ...
    mini_player1 = players.MinimaxPlayer(1, 5)
    mini_player2 = players.MinimaxPlayer(2, 5)

    net_player1 = players.NetPlayer(1, 'medium')
    net_player2 = players.NetPlayer(2, 'medium')

    game_board = GameBoard([mini_player1, net_player2])
